/*
  ...
  - You are about to drop the `ge` table. If the table is not empty, all the data it contains will be lost.
...
CREATE TABLE `users` (
    ...
    `role` ENUM('ADMIN', 'KASIR', 'USER', 'BOS') NOT NULL DEFAULT 'KASIR',
