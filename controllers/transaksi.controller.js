...
export const createTransaksi = async (req, res) => {
    try {
        // detail_transaksi = [{ barang_id: 1, jumlah: 2 }, { barang_id: 2, jumlah: 1 }]
        ...
        // Lakukan perhitungan total harga dan kurangi stok menggunakan transaksi Prisma
        const transaksiResult = await prisma.$transaction(async (tx) => {
            let total_harga = 0;
            const detailTransaksiData = [];

            // 1. Cek stok dan hitung total
